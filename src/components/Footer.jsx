...
const Footer = () => {
  return (
    <footer className="mt-auto flex flex-col text-center py-8 px-4 md:px-8 lg:px-12 border-t-2 border-slate-400 bg-[black] text-white">
      <div className="grid grid-cols-6 gap-x-2 md:gap-x-4 my-4">
        ...
        <div className="col-span-3 md:col-span-2 text-left">
          ...
          <p className="flex flex-col text-xs md:text-base">
            <span>Blog Magazine Head Office</span>
      ...
      <p className="md:flex md:flex-start mt-4">
        &copy; Blog Magazine &nbsp;<span>{new Date().getFullYear()}</span>
      </p>
    </footer>
  );
};
