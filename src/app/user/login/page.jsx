        ...
        <div className="container  mx-auto">
          <div className="flex max-w-md mx-auto flex-col text-center">
            ...
            >
              ...
              <button
                type="submit"
                className="block w-full p-4 text-center text-xs tracking-wider text-white font-semibold leading-none bg-blue-600 hover:bg-blue-700 rounded"
              >
                Sign In
              </button>
              <div className="mt-4 flex items-center justify-between text-xs">
                <Link href="/user/email-verify">Forgot Password?</Link>
                <Link href="/user/register" className="bg-green-600 text-white hover:bg-green-700 rounded px-6 py-2">Sign Up</Link>
              </div>
            </form>
            <div>
